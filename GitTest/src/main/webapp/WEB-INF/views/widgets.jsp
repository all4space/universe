				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							...
							<li class="yellow">
								<a href="#">
									<img class="avatar" alt="Bill" src="/test/resources/bootstrap/img/avatar.jpg">
								</a>
								<strong>Name:</strong> Dennis Ji<br>
								<strong>Since:</strong> Jul 25, 2012 11:09<br>
							...
							<li class="red">
								<a href="#">
									<img class="avatar" alt="Jane" src="/test/resources/bootstrap/img/avatar.jpg">
								</a>
								<strong>Name:</strong> Dennis Ji<br>
								<strong>Since:</strong> Jul 25, 2012 11:09<br>
							...
							<li class="blue">
								<a href="#">
									<img class="avatar" alt="Kate" src="/test/resources/bootstrap/img/avatar.jpg">
								</a>
								<strong>Name:</strong> Dennis Ji<br>
								<strong>Since:</strong> Jul 25, 2012 11:09<br>
				...
				<div class="box span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list">
							...
							<li>
								<a href="#">
									<img class="avatar" alt="" src="/test/resources/bootstrap/img/avatar.jpg">
								</a>
								<strong>Name:</strong> <a href="#">Dennis Ji</a><br>
								<strong>Since:</strong> Jul 25, 2012 11:09<br>
