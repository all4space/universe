						...
						<form class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="startDate" value="">
							  </div>
							...
							<div class="control-group">
							  <label class="control-label" for="date01">Start Date</label>
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="dueDate" value="">
							  </div>
							</div> <!-- START DATE 년/월/일 설정하는법 -->
							...
							<div class="control-group">
							  ...
							  <div class="control-group">
								<label class="control-label" for="groupMemberList">Member Select</label>
								<div class="controls">
								  <select id="groupMemberList" class = "groupMemberList"><!-- multiple data-rel="chosen" -->
